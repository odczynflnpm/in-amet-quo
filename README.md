...
[![build status](https://img.shields.io/travis/odczynflnpm/in-amet-quo/master.svg?style=flat-square)](https://travis-ci.org/odczynflnpm/in-amet-quo)
[![npm version](https://img.shields.io/npm/v/@odczynflnpm/in-amet-quo.svg?style=flat-square)](https://www.npmjs.com/package/@odczynflnpm/in-amet-quo)
...
```sh
npm install @odczynflnpm/in-amet-quo @stripe/stripe-js
```
